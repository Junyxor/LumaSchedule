...
val lumaVersionName = System.getenv("LUMA_VERSION_NAME")?.trim()?.takeIf { it.isNotEmpty() } ?: "0.1.5-beta.1"
val lumaVersionCode = System.getenv("LUMA_VERSION_CODE")?.toIntOrNull()?.takeIf { it in 1..2_100_000_000 } ?: 100501
